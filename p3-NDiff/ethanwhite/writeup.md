...
Then, we need to solve the system of equations (for five equations and five unknowns):

$a+b+c+d+e = 0$ as well as
$-2a-b+d+2e = 1$ as well as
$2a + b/2 + d/2 + 2e = 0$ as well as 
$-4a/3-b/6+d/6+4e/3 = 0$
